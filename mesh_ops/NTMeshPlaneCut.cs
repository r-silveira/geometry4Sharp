...
namespace g4
{
	...
	/// 
	/// [TODO] implement NTMesh3.CollapseEdge() and CollapseDegenerateEdgesOnCut.
	/// </summary>
	public class NTMeshPlaneCut
	{
        // Inputs
		public NTMesh3 Mesh;
        ...
        // Outputs
		public List<NTEdgeLoop> CutLoops;
        public List<NTEdgeSpan> CutSpans;
		...
		/// </summary>
		public NTMeshPlaneCut(NTMesh3 mesh, Vector3d origin, Vector3d normal)
		{
			Mesh = mesh;
			PlaneOrigin = origin;
			PlaneNormal = normal;
		...
		public virtual bool Cut()
		{
            ...
            //NTMeshEdgeSelection CutEdgeSet = null;
            //NTMeshVertexSelection CutVertexSet = null;
            //if (CutFaceSet != null) {
            //    CutEdgeSet = new NTMeshEdgeSelection(Mesh, CutFaceSet);
            //    CutVertexSet = new NTMeshVertexSelection(Mesh, CutEdgeSet);
            //}
            ...
            foreach (int eid in edgeItr) { 
				...
				foreach (var splitNewEdge in splitInfo.NewEdges)
				{
                    NewEdges.Add(splitNewEdge);
                    OnCutEdges.Add(splitNewEdge);
                }
			}
			...
			try {
				var loops = new NTMeshBoundaryLoops(Mesh, false);
